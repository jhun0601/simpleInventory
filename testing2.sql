...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-11-2017 a las 20:50:04
...
--
-- Estructura de tabla para la tabla `inventory_order`
--
...
--
-- Volcado de datos para la tabla `inventory_order`
--
...
--
-- Estructura de tabla para la tabla `inventory_order_product`
--
...
--
-- Volcado de datos para la tabla `inventory_order_product`
--
...
(10, 'admin@hotmail.com', '$2y$10$qj6i93bnwZ6Y1.AP1UAPEuMnOxFKz/nG/IR83HyWsVxmgqIOMH3bq', 'admin', 'master', 'Active');
